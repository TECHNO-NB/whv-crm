...
// Menu Configuration
const adminMenu = [
  { name: "Dashboard", icon: Home, href: "/IT/dashboard" },
  { name: "Message", icon: MessageCircle, href: "/IT/message", count: true },
  { name: "Tickets", icon: TicketsPlane, href: "/IT/tickets" },
];
...
export default function ITSidebar() {
  ...
  return (
    <>
      {/* Mobile Top Bar */}
      <div className="md:hidden flex items-center justify-between bg-[#FFF8E6] backdrop-blur-md border-b px-4 py-3 sticky top-0 z-50">
        <h1 className="text-lg font-semibold text-[#4A2C2A]">Admin Dashboard</h1>
        <button
      ...
      >
        ...
        <div className="px-4 py-5 border-b border-white/20 flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <h2 className="text-lg font-semibold text-white">I.T</h2>
            <p className="text-xs text-white/80">Information & Technology</p>
          </div>
          <div className="ml-auto font-semibold text-sm bg-white/20 px-2 py-0 text-white rounded-2xl">
            I.T
          </div>
        </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "bg-gradient-to-r from-[#FF6F00] to-[#FF8F00] text-white shadow-lg"
              ...
              >
                ...
                {item.count && messageCount > 0 ? (
                  <div className="relative left-20">
                    ...
                    <Bell color="white" size={22} className="opacity-90" />
                  </div>
                ) : null}
              </Link>
            );
