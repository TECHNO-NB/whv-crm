...
// Menu configuration
const adminMenu = [
  { name: "Dashboard", icon: Home, href: "/manager/dashboard" },
  { name: "Users", icon: Users, href: "/manager/users" },
  { name: "Projects", icon: Pickaxe, href: "/manager/projects" },
  { name: "Finances", icon: DollarSign, href: "/manager/finances" },
  { name: "Report", icon: ChartColumnDecreasing, href: "/manager/report" },
  { name: "Message", icon: MessageCircle, href: "/manager/message", count: true },
  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center justify-between bg-[#FFF5E6] backdrop-blur-md border-b px-4 py-3 sticky top-0 z-50">
        <h1 className="text-lg font-semibold text-[#4A2C2A]">Country Manager</h1>
        <button
      ...
      >
        ...
        <div className="px-4 py-5 border-b border-white/20 flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <h2 className="text-lg font-semibold text-white">Country Manager</h2>
