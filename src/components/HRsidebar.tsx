...
// HR Sidebar Menu
const adminMenu = [
  { name: "Dashboard", icon: Home, href: "/HR/dashboard" },
...
export default function HRSidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 z-50 h-full w-64 md:w-72 bg-gradient-to-b from-[#FF8A00] to-[#E65100] text-white shadow-xl flex flex-col transition-transform duration-200",
      ...
      >
        ...
        <div className="px-4 py-5 border-b border-white/20 flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <h2 className="text-lg font-semibold text-white">H.R</h2>
            <p className="text-xs text-white/80">User Management</p>
          </div>

          <div className="ml-auto text-xs bg-[#FFE0B2] text-black px-2 py-0.5 rounded-xl font-semibold">
            H.R
          </div>
        </div>
