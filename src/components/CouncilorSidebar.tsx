...
// Menu configuration
const adminMenu = [
  { name: "Dashboard", icon: Home, href: "/councilor/dashboard" },

  { name: "Projects", icon: Pickaxe, href: "/councilor/projects" },
  { name: "Finances", icon: DollarSign, href: "/councilor/finances" },
  { name: "Report", icon: ChartColumnDecreasing, href: "/councilor/report" },
  {
    name: "Message",
    icon: MessageCircle,
    href: "/councilor/message",
    count: true,
  },
  { name: "Notification", icon: Bell, href: "/councilor/notification" },
];

export default function CouncilorSidebar() {
      ...
      >
        ...
        <div className="px-4 py-5 border-b border-white/20 flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <h2 className="text-lg font-semibold text-white">Councilor</h2>
