...
import ProjectsAddFilterComp from "@/components/ProjectsAddFilterComp";
...
const page = () => {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        const res = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v1/managerprojects/${userData?.countryId}`, {
